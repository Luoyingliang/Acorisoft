...
namespace Acorisoft.Morisa.Documents
{
    ...
    /// 采用5星稀有度制度。
    /// </remarks>
    public class AbilityRarity : ItemRarity
    {
        ...
        public sealed override int CompareTo(ItemRarity? other)
        {
            return other is not AbilityRarity ar ? ComparableHelper.LessThen() : _rarity.CompareTo(ar._rarity);
        }
